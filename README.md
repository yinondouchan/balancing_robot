...
The body is made of multiple 3d printed components, held together mostly by nuts and bolts. The components were designed in FreeCAD, converted to STL mesh files, sliced to gcode files and printed.
